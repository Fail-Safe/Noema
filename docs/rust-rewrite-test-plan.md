...
Standard mode still needs explicit process-death and real power-loss
expectations because it intentionally omits the pending-mutation journal and
per-file fsyncs. Automatic restore reconciliation is deliberately
