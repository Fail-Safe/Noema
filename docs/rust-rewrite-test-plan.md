...
Pixel-level and multi-emulator human TUI validation, corrupt-DB salvage,
automatic startup restore reconciliation, power-loss qualification, older-Go
takeover safety, and broader adversarial real-model quality evaluation still
