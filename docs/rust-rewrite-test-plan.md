...
Pixel-level/live-terminal TUI validation, corrupt-DB salvage, automatic
restore-artifact reconciliation, power-loss qualification, older-Go takeover
safety, and broader adversarial real-model quality evaluation still require
ports and parity fixtures.
