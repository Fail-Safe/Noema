...
Pixel-level/live-terminal TUI validation, corrupt-DB salvage and recovery
status, restore-transaction crash injection, power-loss qualification,
older-Go takeover safety, and broader adversarial real-model quality evaluation
still require ports and parity fixtures.
