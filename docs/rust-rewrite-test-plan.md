...
validation, broader adversarial real-model evaluation, and staged packaging /
rollback policy remain. Automatic restore reconciliation is deliberately not a
goal because ambiguous or tampered state requires an explicit operator choice.
