...
and ranking, full consolidation/election behavior, certificate-expiry monitoring,
plugin installation, watcher onboarding/healing, divergence resolution, and full
TUI behavior still require ports and parity fixtures.
