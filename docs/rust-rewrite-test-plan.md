...
Pixel-level/live-terminal TUI validation, corrupt-DB salvage, automatic startup
restore reconciliation, power-loss qualification, older-Go takeover safety,
and broader adversarial real-model quality evaluation still require ports and
parity fixtures.
